...
func main() {
	...
	{
		ticketRoutes.GET("/", handler.GetAllTickets())
		ticketRoutes.GET("/getByDestination/:destination", handler.GetTicketsByDestination())
		ticketRoutes.GET("/getByAverage/:destination", handler.GetAveragePeopleByDestination())
	}
